    ...
    switch (req.url) {
		...
		case '/':
            ...
            for ( var i = 0; i < movies.length; i++) {
                titulos.push(movies[i].original_title)
                
            }
            res.end('Bienvenidos a DH Movies el mejor sitio para encontrar las mejores peliculas inculso mucho mejor que Netflix. \n El total de peliculas es:  \n Recorda que podes visitrno en: \n cartelera: \n ' + titulos + '\n Mas votados \n Sucursales \n contacto \n Preguntas frecuentes');
            break;
            
            // En cartelera
		case '/en-cartelera':
    
			res.end('En cartelera' + console.log(movies));
            break;
		...
		case '/preguntas-frecuentes':
			...
			res.end('Preguntas Frecuentes' + console.log(faqs));
			break;
		default:
